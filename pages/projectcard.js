    ...
    return (
        <div>
            <div
                ...
                className="bg-cover bg-center h-52 md:h-72 rounded-t-xl relative group"
            >
                <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-slate-400 bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-70 transition-all duration-500">
                    ...
                    <Link
                        href={previewUrl}
                        className="h-14 w-14 border-2 relative rounded-full border-white hover:border-slate-700 flex items-center justify-center group/link"
                    >
